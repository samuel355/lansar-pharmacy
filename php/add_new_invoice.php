<?php
  ...
  function createMedicineInfoRow() {
    ...
    <div class="row col col-md-12">
      ...
      <div class="col col-md-2"><input type="text" class="form-control" id="diagnose_name_<?php echo $row_number; ?>" disabled></div>
  ...
  function addSale() {
    ...
    $diagnose_name = $_GET['diagnose_name'];
    ...
    require "db_connection.php";
    if($con) {
      $query = "INSERT INTO sales (CUSTOMER_ID, INVOICE_NUMBER, MEDICINE_NAME, DIAGNOSE_NAME, EXPIRY_DATE, QUANTITY, MRP, DISCOUNT, TOTAL) VALUES($customer_id, $invoice_number, '$medicine_name', '$diagnose_name', '$expiry_date', $quantity, $mrp, $discount, $total)";
      $result = mysqli_query($con, $query);
